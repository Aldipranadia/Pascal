...
var
        ...
        procedure pembelianapartemen(var trans:transaksi;var ap:apartemen;var max_t:integer;max_ap:integer;var jum:longint);
        var
          x:string;
          z,n,kluar,i,o:integer;
          anslist:string;
        begin
          if (max_ap=0) then
                  begin
        ...
        procedure infotransaksi(ap:apartemen;trans:transaksi;max_t:integer;var jum:longint);
        var
          p,q,z,i,id:integer;
          f:boolean;
          pay:longint;
        ...
        begin
                ...
                case pilihan of
                      '1':begin
                        ...
                        '5':begin
                            clrscr;
                            pembelianapartemen(ar_trans,ar_apartment,nmax_t,nmax_ap,total);
                            clrscr;
                            mainmenu;
                            end;
                        '6':begin
                            clrscr;
                            infotransaksi(ar_apartment,ar_trans,nmax_t,total);
                            clrscr;
                            mainmenu;
                            end;
                        '7':begin
